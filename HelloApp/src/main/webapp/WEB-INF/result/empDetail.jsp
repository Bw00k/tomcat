...
%>
<%=age %>, <%=id %>
<h3>현재 페이지는 empDetail.dp의 결과 empDetail.jsp입니다.</h3>
...
<th>FirstName</th><td><%=emp.getFirstName() %></td>
 ...
 <tr>
  ...
  <button class= "btn btn-warning"  onclick="location.href='empRemove.do?id=<%=emp.getEmployeeId() %>'">삭제</button> <!--  empRemove.do>id=?? -->
  </td>
	</tr>
